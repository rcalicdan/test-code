...
require_once ASARINOS_PLUGIN_DIR . 'includes/asarinos/class-asarinos-core.php';
require_once ASARINOS_PLUGIN_DIR . 'includes/asarinos/class-asarinos-media.php';
require_once ASARINOS_PLUGIN_DIR . 'includes/asarinos/class-asarinos-property-manager.php';
require_once ASARINOS_PLUGIN_DIR . 'includes/asarinos/class-asarinos-api-client.php';
require_once ASARINOS_PLUGIN_DIR . 'includes/asarinos/class-asarinos-admin.php';
require_once ASARINOS_PLUGIN_DIR . 'includes/asarinos/class-asarinos-frontend.php';
require_once ASARINOS_PLUGIN_DIR . 'includes/asarinos/class-asarinos-cron.php';
require_once ASARINOS_PLUGIN_DIR . 'includes/asarinos/class-asarinos-shortcodes.php';
